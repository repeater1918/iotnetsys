        ...
        *top_page_heading("Node level"),
        ...
        dbc.Row(
            [
                ...
                dbc.Col(get_e2e_graph(is_init=True, node_id=nodeid), md=6, style={"margin-top": "16px"}),
                dbc.Col(get_deadloss_graph(is_init=True, node_id=nodeid), md=6, style={"margin-top": "16px"}),
